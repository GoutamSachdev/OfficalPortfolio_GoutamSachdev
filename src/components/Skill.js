...
const Skill = () => {
  return (
    <>
    <h2 className='font-bold text-8xl mt-52 mb-6 w-full text-center' >
        Skills
    </h2>
    <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circulerLight'>
      ...
      <Skills name="NumPy" x='15vw' y='-12vw ' />
